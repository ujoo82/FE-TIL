...
const postpreStyle = `relative bg-graylv1 p-4 rounded-[10px] mb-6 text-base font-medium whitespace-pre-wrap break-words text-justify max-w-full h-auto align-middle`;
...
const posttableStyle = `table-auto w-auto border-collapse mb-6 h-auto align-middle border-graylv2 text-justify`;
const posttheadStyle = `text-justify`;
...
const posttbodyStyle = `text-justify`;
